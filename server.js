...
app.post('/sendOTP',(req,res)=>{
    ...
    client.messages.create({
        body:` Aur bhai ky haal hai.. OTP KISI SAI SHARE MAT KARNA  Your one time password for CFM IS ${otp}`,
        from: +19403736786,
        to: phone
...
app.post('/verifyOTP',(req,res)=>{
    ...
    if(newCalculatedHash==hashValue){
        ...
        res.status(202)
        .cookie('accessToken',accessToken,{expires:new Date(new Date().getTime()+30*1000),
            sameSite:'strict',
            httpOnly:true
